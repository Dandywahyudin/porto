...
const projectsData: ProjectItem[] = [
  {
    ...
    subtitle: "Fullstack E-Commerce Platform",
    role: "Lead FullStack Developer & UI Designer",
    services: "Web Application, Payment Gateway, Inventory System",
    platform: "Next.js, Tailwind CSS, PostgreSQL, Prisma",
    url: "https://github.com/Dandywahyudin",
    github: "https://github.com/Dandywahyudin",
    description:
      "A high-performance e-commerce platform engineered for scale, artisanal product showcase, and seamless localized payment workflows.",
    fullStory: [
      "Designed and engineered for Nusantara Store, this platform empowers local artisanal craftsmen and heritage businesses across Indonesia to showcase and sell high-quality cultural products globally.",
      "To address high traffic during seasonal product drops and complex multi-region shipping calculations, I architected a high-throughput PostgreSQL backend with edge-cached Next.js App Router frontends.",
      "The interface adopts a high-contrast neo-brutalist dark aesthetic, paired with instant QRIS/e-wallet checkout workflows, automated weight-based courier calculations, and real-time inventory matrix management.",
    ],
    features: [
      "Edge-Rendered High Performance Product Catalog",
      "Seamless Multi-Payment Gateway (QRIS, E-Wallet, VA)",
      "Automated Regional Courier Rate Calculation",
      "Real-time Inventory Telemetry & Admin Analytics",
    ],
  ...
  },
  {
    ...
    subtitle: "Enterprise Analytics & Infrastructure Monitoring",
    role: "Frontend Architect & Data Visualization Engineer",
    services: "SaaS Dashboard, Real-Time Telemetry, Node Topology",
    platform: "Vue 3 / React, TypeScript, D3.js, Tailwind CSS",
    url: "https://github.com/Dandywahyudin",
    github: "https://github.com/Dandywahyudin",
    description:
      "Enterprise-grade data visualization dashboard with low-latency real-time telemetry streaming and infrastructure topology management.",
    fullStory: [
      "Kelola Dashboard is an enterprise-grade infrastructure observability platform designed to monitor distributed cloud servers, database clusters, and global network nodes in real time.",
      "I engineered an ultra-fast rendering pipeline capable of processing 50,000+ telemetry datapoints per second without frame drops using custom canvas-accelerated D3 charts and WebSocket event streams.",
      "The layout allows DevOps teams to inspect node cluster health, latency heatmaps, CPU/memory saturation, and receive instant alert notifications with contextual trace logs.",
    ],
    features: [
      "Interactive Server Network Topology Mapping",
      "Sub-50ms WebSocket Live Data Synchronization",
      "Dynamic Latency & Node Saturation Heatmap",
  ...
  },
  {
    ...
    subtitle: "Digital Architectural Publication & Monograph Archive",
    role: "Design Technologist & Frontend Engineer",
    services: "Editorial Web Design, CMS Architecture, Typography",
    platform: "Next.js, Tailwind CSS, Sanity Headless CMS",
    url: "https://github.com/Dandywahyudin",
    github: "https://github.com/Dandywahyudin",
    description:
      "A digital publication platform focusing on structural design, brutalist architecture, and spatial photography essays.",
    fullStory: [
      "A digital publication and visual archive celebrating brutalist architecture, raw structural geometry, and contemporary spatial theory.",
      "Inspired by Swiss grid systems and international typographic style, the platform presents long-form photographic essays and architectural deep-dives with asymmetric split layouts and dynamic scroll choreography.",
      "Built with a headless content architecture enabling editors to construct bespoke narrative layouts for each featured monograph with rich typography.",
    ],
    features: [
      "Swiss Grid Asymmetrical Editorial Layouts",
      "Dynamic Headless CMS Schema & Visual Block Builder",
      "Fluid Typography & High-DPI Architectural Imagery",
      "Dark / Light Structural Neo-Brutalist Theme",
    ],
    tags: ["Next.js", "Tailwind CSS", "Sanity CMS", "TypeScript"],
    banner: "/projects/zine-1.jpg",
    images: ["/projects/zine-1.jpg", "/projects/zine-2.jpg"],
  },
  {
    id: "project-obsidian",
    year: "2024",
